	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
					<@spring.message "gms.yysj.yysj"/> <small><@spring.message "gms.yysj.sszxcx"/></small>
				</h3>
				<@navBar />
		...
		<!-- BEGIN PAGE CONTENT-->
		<form id="mainform" actionlist="?module=online&action=onlinelist" actionexport="?module=online&action=onlineexport" method="post">
					...
					<div class="portlet box" id="portlet_1">
						<div class="portlet-body">
							<div id="sample_editable_1_wrapper" class="dataTables_wrapper"
									...
									<table
										...
										<thead>
											<tr class="heading" role="row">
												<th><@spring.message "gms.yysj.sszxzhs"/></th>
												<th><@spring.message "gms.yysj.shijiandian"/></th>
											</tr>
										</thead>
										...
										<#list datas as dt>
							                <tr class="${(dt_index%2 == 0)?string("odd", "even")}">
							                	<td>${dt.onlineCount?default("0")}</td>
								...
								<@pageNav page=page url_pattern='?module=online&action=onlinelist&curPage=$$_NO_$$' />
							</div>
