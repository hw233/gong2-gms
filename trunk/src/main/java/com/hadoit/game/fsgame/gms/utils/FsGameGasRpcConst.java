...
public class FsGameGasRpcConst {
	// gms -> admin
	...
	public static final String ADMIN_REQ_GET_PLAYER_LIST_VIP="admin.getPlayerListvip";
	...
	public static final String ADMIN_REQ_MPLAYINFO = "admin.mplayinfo";//玩家信息更新
	public static final String ADMIN_REQ_MPLAYITEM = "admin.mplayitem";//玩家物品操作
	public static final String ADMIN_REQ_MPLAYMESSAGE = "admin.mplaymessage";//玩家邮件操作
	public static final String ADMIN_REQ_DPLAYITEM = "admin.dplayitem";//玩家物品操作
	public static final String ADMIN_REQ_DPLAYMESSAGE = "admin.dplaymessage";//玩家邮件操作
	public static final String ADMIN_REQ_DPLAYBUILD = "admin.dplaybuild";//玩家建筑操作
	public static final String ADMIN_REQ_DELPLAYBUILD = "admin.delplaybuild";//玩家建筑删除
