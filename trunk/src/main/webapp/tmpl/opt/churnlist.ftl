	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
					<@spring.message "gms.yysj.yysj"/> <small><@spring.message "gms.yysj.liushitongji"/></small>
				</h3>
				<@navBar />
		...
		<!-- BEGIN PAGE CONTENT-->
		<form id="mainform" actionlist="?module=churn&action=churnlist" actionexport="?module=churn&action=churnexport" method="post">
									...
									<table
										...
										<thead>
											<tr class="heading" role="row">
												...
												<th><@spring.message "gms.yysj.crlszh"/></th>
												<th><@spring.message "gms.yysj.crlsl"/></th>
												<th><@spring.message "gms.yysj.qrlsl"/></th>
											</tr>
										</thead>
										...
										<#list datas as dt>
							                <tr class="${(dt_index%2 == 0)?string("odd", "even")}">
							                    ...
							                    <td>${dt.churnCount1?default("-")}</td>
							                    <td>${dt.churnRatio1?string("0.##%")}</td>
							                    <td>${dt.churnRatio2?string("0.##%")}</td>
							                </tr>
							            </#list>
										</tbody>
									</table>
								</div>
								<@pageNav page=page url_pattern='?module=churn&action=churnlist&curPage=$$_NO_$$' />
							</div>
