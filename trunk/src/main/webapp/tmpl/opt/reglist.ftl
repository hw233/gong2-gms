	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
					<@spring.message "gms.yysj.yysj"/> <small><@spring.message "gms.yysj.zhucetongji"/></small>
				</h3>
				<@navBar />
		...
		<!-- BEGIN PAGE CONTENT-->
		<form id="mainform" actionlist="?module=reg&action=reglist" actionexport="?module=reg&action=regexport" method="post">
					...
					<div class="portlet box" id="portlet_1">
						<div class="portlet-body">
							<div id="sample_editable_1_wrapper" class="dataTables_wrapper"
									...
									<table
										...
										<thead>
											<tr class="heading" role="row">
												...
												<th><@spring.message "gms.yysj.rxzzh"/></th>
							                    <th><@spring.message "gms.yysj.rhyzh"/></th>
							                    <th><@spring.message "gms.yysj.crlcl"/></th>
							                    <th><@spring.message "gms.yysj.rzgzx"/></th>
							                    <th><@spring.message "gms.yysj.rjzx"/></th>
										...
										<#list datas as dt>
							                <tr class="${(dt_index%2 == 0)?string("odd", "even")}">
							                    ...
							                    <td>${dt.maxOnlineCount?default("-")}</td>
							                    <td>${dt.avgOnlineCount?default("-")}</td>
								...
								<@pageNav page=page url_pattern='?module=reg&action=reglist&curPage=$$_NO_$$' />
							</div>
