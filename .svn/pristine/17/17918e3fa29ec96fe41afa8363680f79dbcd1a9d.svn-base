	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<h3 class="page-title">
					<@spring.message "gms.youxi.yysj"/> <small><@spring.message "gms.youxi.xfxwtj"/></small>
				</h3>
				<@navBar />
		...
		<!-- BEGIN PAGE CONTENT-->
		<form id="mainform" actionlist="?module=csmbehv&action=csmbehvlist" actionexport="?module=csmbehv&action=csmbehvexport" method="post">
			...
			<div class="row">
				...
				<div class="col-md-2" style="text-align:right;">
					<select id="behv" name="behv" class="bs-select form-control" >
					    <option value="0" <#if behv=="0">selected</#if>>All</option>
					    <#list behvOption?keys as key>
					     	<option value="${key}" <#if behv==key>selected</#if>>${spring.f_message(behvOption[key])}</option>
		                </#list>
					</select>
				</div>
					...
					<div class="portlet box" id="portlet_1">
						<div class="portlet-body">
							<div id="sample_editable_1_wrapper" class="dataTables_wrapper"
									...
									<table
										...
										<thead>
											<tr class="heading" role="row">
												...
												<th><@spring.message "gms.youxi.xingwei"/></th>
										...
										<#list datas as dt>
							                <tr class="${(dt_index%2 == 0)?string("odd", "even")}">
							                    ...
							                    <td>${spring.f_message(FsGameGmsUtils.getBehv(dt.behv))}</td>
								...
								<@pageNav page=page url_pattern='?module=csmbehv&action=csmbehvlist&curPage=$$_NO_$$' />
							</div>
